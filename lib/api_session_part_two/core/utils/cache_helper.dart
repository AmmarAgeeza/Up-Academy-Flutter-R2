...
// remove data using specific key
  ...
  final String _cachedTheme = "cachedTheme";
  String? getCachedThemeMode() {
    return sharedPreferences.getString(_cachedTheme);
  }

  Future<void> cacheThemeMode(String code) async {
    await sharedPreferences.setString(_cachedTheme, code);
  }
}
